...
export const metadata: Metadata = {
	...
	description: `${tweet.content} · Views: ${tweet.stats.views} · ♥ ${formatShort(
		tweet.stats.likes
	)} · 💬 ${tweet.stats.comments} · 🔁 ${formatShort(tweet.stats.retweets)}`,
	openGraph: {
		title: `${tweet.author.name} — ${tweet.content.slice(0, 80)}`,
		description:
			`${tweet.content} · Views: ${tweet.stats.views} · ♥ ${formatShort(
				tweet.stats.likes
			)} · 💬 ${tweet.stats.comments} · 🔁 ${formatShort(
